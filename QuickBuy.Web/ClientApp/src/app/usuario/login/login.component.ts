...
export class LoginComponent implements OnInit {
  ...
  constructor(private router: Router, private activateroute: ActivatedRoute, private usuariosService: UsuariosService) {
  ...
  public entrar() {
    ...
    /*if ((this.usuario.email === 'wellington.olimpios@gmail.com') && (this.usuario.senha === '123')) {
      sessionStorage.setItem("usuario-autenticado", "1");
      this.router.navigate([this.retornoUrl]);
    }*/
  }
